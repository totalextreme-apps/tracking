      ...
      >
        ...
        {isEmpty ? (
          ...
          <>
            ...
            {/* Format Filters */}
            <ScrollView horizontal showsHorizontalScrollIndicator={false} className="mb-4 pl-4" contentContainerStyle={{ paddingRight: 16 }}>
            ...
            {/* Sort Options */}
            <ScrollView horizontal showsHorizontalScrollIndicator={false} className="mb-6 pl-4" contentContainerStyle={{ paddingRight: 16 }}>
              {[
