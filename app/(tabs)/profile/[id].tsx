    ...
    result.sort((a, b) => {
      ...
      switch (sortBy) {
        ...
        case 'format':
          ...
          break;
        case 'value':
          const valA = a.value_estimate ?? -1;
          const valB = b.value_estimate ?? -1;
          ...
          <View className="px-4">
            ...
            <View className="bg-neutral-900 mb-6 p-4 rounded-xl border border-neutral-800 z-50">
                <View className="flex-row items-center gap-2 mb-2 flex-wrap">
                  ...
                  {[{ id: 'recent', label: 'RECENT' }, { id: 'title', label: 'NAME' }, { id: 'release', label: 'YEAR' }, { id: 'rating', label: 'RATING' }, { id: 'value', label: 'VALUE' }].map((s: any) => (
