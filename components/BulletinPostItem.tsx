...
export function BulletinPostItem({ post, userId, idx, startEditing, setShowDeleteConfirm, isFocused, onReplyPress, CommentSectionComponent }: any) {
  ...
  return (
    <View collapsable={false} ref={viewRef} style={{ backgroundColor: 'rgba(255,252,225,1)', borderRadius: 2, padding: 12, marginBottom: 16, transform: [{ rotate: idx % 2 === 0 ? '-1deg' : '1deg' }], shadowColor: '#000', shadowOffset: { width: 2, height: 4 }, shadowOpacity: 0.35, shadowRadius: 5 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, paddingTop: 8, borderTopWidth: 1, borderTopColor: 'rgba(0,0,0,0.05)' }}>
        <Pressable onPress={onReplyPress} style={{ flexDirection: 'row', alignItems: 'center' }}>
