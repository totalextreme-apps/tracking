...
begin
  select jsonb_build_object(
    ...
    'titles_in_circulation', (select count(*) from collection_items),
    'special_requests', (select count(*) from collection_items where status = 'wishlist'),
    'most_wanted', (select count(*) from collection_items where is_grail = true)
  ) into result;
  return result;
end;
$$;
